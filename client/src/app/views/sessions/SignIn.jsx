    ...
    return (
      <div className="signup flex flex-center w-100 h-100vh">
        <div className="p-8">
          ...
          <Card className="signup-card position-relative y-center" style={{display:'flex'}}>
          
                  <img src={logo} alt="logo6688" className="logo" style={{width:"25%",height:"25%", marginLeft:"20%", marginTop:"5%"}}/>
              ...
              <Grid item lg={7} md={7} sm={7} xs={12}>
                <div className="p-36 h-100 bg-light-gray position-relative">
                  <ValidatorForm ref="form" onSubmit={this.handleFormSubmit}>
                    ...
                    <p class="bold" style={{textAlign: "center", marginBottom: 0}}>Hotline: 0968399620</p>
                  </ValidatorForm>
                </div>
              </Grid>
            </Grid>
